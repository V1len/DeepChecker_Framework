...
if __name__ == '__main__':
    ...
    data_path = time_basic_data_path + "time_data.csv"
    train_data_path = time_basic_data_path + "time_train_data.csv"
    test_data_path = time_basic_data_path + "time_test_data.csv"
